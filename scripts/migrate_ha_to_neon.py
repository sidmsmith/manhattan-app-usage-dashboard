...
Usage:
    python scripts/migrate_ha_to_neon.py

Requirements:
    - sqlite3 (built-in)
    - psycopg2-binary: pip install psycopg2-binary
    - Access to HA database file (usually /config/home-assistant_v2.db)
...
# Configuration
HA_DB_PATH = '/config/home-assistant_v2.db'  # Default HA database path
...
def main():
    ...
    try:
        ...
        print(f"\n❌ Error: {e}")
        print("\n💡 Tip: Set HA_DB_PATH environment variable or update script with correct path")
        sys.exit(1)
