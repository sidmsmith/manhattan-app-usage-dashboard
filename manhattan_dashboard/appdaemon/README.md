...
```
manhattan_dashboard/appdaemon/appdaemon.yaml
manhattan_dashboard/appdaemon/apps/apps.yaml
manhattan_dashboard/appdaemon/apps/custom_event_logger.py
manhattan_dashboard/appdaemon/README.md
```
